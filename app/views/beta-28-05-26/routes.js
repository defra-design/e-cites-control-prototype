...
module.exports = (router) => {
  ...
  const PERMIT_SEARCH_DATA = {
    '26GBIMPABS719': {
      ...
      exporterName: 'Harika Cicek Balikcilik ve Su Urunleri Ith Ihr San ve Tic Ltd Sti',
      exporterAddressHtml: 'Cay Mah<br>Haci Yunusazade Mehmet Gunesdogdu Cad<br>No: 73 55500<br>Carsamba Samsun<br>Turkey',
      countryOfReexport: 'Turkey',
      importerName: 'Biopharm UK Ltd',
      importerAddressHtml: '2 Bryngwili Road<br>Pontardulais<br>Swansea<br>SA4 0XT<br>United Kingdom',
