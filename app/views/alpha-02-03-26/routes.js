// Alpha 02-03-26 routes – single and batch search results journeys
...
module.exports = (router) => {
  ...
  const PERMIT_SEARCH_DATA = {
    ...
    '25GBIMPSTYXH1': { species: 'Python bivittatus', commonName: 'Burmese python', description: 'Live Burmese python.<br>Microchip number 12345678912345', expires: '30 October 2026', quantity: '1', citesAppendix: 'II', gbAnnex: 'B' },
    '25GBIMPSTYHNO': { species: 'Python bivittatus', commonName: 'Burmese python', description: 'Live Burmese python.<br>Microchip number 12345678912345', expires: '30 October 2026', quantity: '1', citesAppendix: 'II', gbAnnex: 'B' },
    '25GBIMPUVWOFM': { species: 'Python bivittatus', commonName: 'Burmese python', description: 'Live Burmese python.<br>Microchip number 12345678912345', expires: '30 October 2026', quantity: '1', citesAppendix: 'II', gbAnnex: 'B' },
    '25GBIMPWX0N12': { species: 'Python bivittatus', commonName: 'Burmese python', description: 'Live Burmese python.<br>Microchip number 12345678912345', expires: '30 October 2026', quantity: '1', citesAppendix: 'II', gbAnnex: 'B' },
    '25GBIMPYZOPGY': { species: 'Python bivittatus', commonName: 'Burmese python', description: 'Live Burmese python.<br>Microchip number 12345678912345', expires: '30 October 2026', quantity: '1', citesAppendix: 'II', gbAnnex: 'B' },
    '25GBIMPABZPMT': { species: 'Python bivittatus', commonName: 'Burmese python', description: 'Live Burmese python.<br>Microchip number 12345678912345', expires: '30 October 2026', quantity: '1', citesAppendix: 'II', gbAnnex: 'B' },
    '25GBIMPCDO2DA': { species: 'Python bivittatus', commonName: 'Burmese python', description: 'Live Burmese python.<br>Microchip number 12345678912345', expires: '30 October 2026', quantity: '1', citesAppendix: 'II', gbAnnex: 'B' },
    '25GBIMPEFPJOB': { species: 'Python bivittatus', commonName: 'Burmese python', description: 'Live Burmese python.<br>Microchip number 12345678912345', expires: '30 October 2026', quantity: '1', citesAppendix: 'II', gbAnnex: 'B' },
    '25GBIMPGHAQTG': { species: 'Python bivittatus', commonName: 'Burmese python', description: 'Live Burmese python.<br>Microchip number 12345678912345', expires: '30 October 2026', quantity: '1', citesAppendix: 'II', gbAnnex: 'B' },
